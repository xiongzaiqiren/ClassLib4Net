...
namespace ClassLib4Net.VerificationCode
{
    /// <summary>
    /// 图形验证码
    /// 熊学浩
    ...
    public class Captcha
    {
        ...
        /// <returns></returns>
        public static Image Generate(string captchaText, int width = 0, int height = 0, Font font = null)
        {
            //int fontsize = 24;
            font = null != font ? font : new Font("Arial", 24);
            ...
            int image2d_y = (int)(font.Size * 1.3);
            ...
            int image3d_x = width > 0 ? width : 256;
            int image3d_y = height > 0 ? height : image3d_x * 9 / 16;
