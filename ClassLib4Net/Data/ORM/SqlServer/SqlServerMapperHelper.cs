...
namespace ClassLib4Net.Data.ORM.SqlServer
{
    ...
    public class SqlServerMapperHelper<T> : DataRowMapperHelper<T> where T : class
    {
        ...
        public virtual List<T> LoadAll(SqlDataReader reader)
        {
        ...
        private List<string> _canLoadColumnNames;
        public virtual List<string> CanLoadColumnNames(T t)
        {
        ...
        public virtual List<string> CanLoadColumnNames()
        {
        ...
        public virtual string CanLoadColumnNamesString()
        {
            ...
            {
                List<string> columnNames = CanLoadColumnNames();
        ...
        protected virtual string GetInsertCommand(T t, out string IdentityParameterName, out List<SqlParameter> parameters)
        {
        ...
        protected virtual string GetUpdateCommand(T t, out List<SqlParameter> parameters)
        {
            parameters = new List<SqlParameter>();
            if (null == t) return string.Empty;
