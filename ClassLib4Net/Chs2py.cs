...
namespace ClassLib4Net
{
	...
	public class Chs2py
	{
		...
		public static char GetFirstPyChar(char c) 
		{
            string pinyin = GetFullChs2Py(c.ToString());

            if (!string.IsNullOrEmpty(pinyin))
            {
                return pinyin.ToUpper()[0]; 
            }

            return ' ';
            
            //return GetFirstPyChar("" + (char)c); 
		} 
        /// <summary>
        /// 取单个汉字的拼音首字母
        /// </summary>
        ...
        /// <returns>第一个拼音字母</returns>
		public static char GetFirstPyChar(string strName) 
		{


            if (!string.IsNullOrEmpty(strName))
            {
                return GetFirstPyChar(strName[0]);
            }
            ...
            ////数字
            //if( code >= 32 && code <= 64 ) return char.ToUpper('1'); 
            //// 英文字符区 
            //if( code >= 65 && code <= 126 ) return char.ToUpper(strName[0]); 
            //// 全角字符区 
            //if(strName[0] >= 'Ａ' && strName[0] <= 'Ｚ') 
            //    return (char)(strName[0] - 'Ａ' + 'A'); 

            //if(strName[0] >= 'ａ' && strName[0] <= 'ｚ') 
            //    return (char)(strName[0] - 'ａ' + 'A'); 

            //if(strName[0] >= '０' && strName[0] <= '９') 
            //    return (char)(strName[0] - '０' + '0'); 
        ...
        /// <returns>拼音</returns>
		public static string GetFullChs2Py(string chineseString)
		{
            
           // ChineseProvider.IsValidChar
